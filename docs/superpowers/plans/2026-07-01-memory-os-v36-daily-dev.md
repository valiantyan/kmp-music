...
- [x] **Step 1: Run classifier behavior check before change**
...
- [x] **Step 2: Replace classifier regexes**
...
- [x] **Step 3: Keep classifier as layer-only logic**
...
- [x] **Step 4: Run classifier behavior check after change**
...
- [x] **Step 5: Commit classifier changes**
...
- [x] **Step 1: Run validator checks before change**
...
- [x] **Step 3: Replace active decision block**
...
- [x] **Step 4: Run validator checks after change**
...
- [x] **Step 5: Commit validator policy**
...
- [x] **Step 1: Update compiled context title**
...
- [x] **Step 2: Raise Stop confidence only for explicit learning summaries**
...
- [x] **Step 3: Verify Stop confidence behavior**
...
- [x] **Step 4: Update audit static checks**
...
- [x] **Step 5: Update audit runtime checks**
...
- [x] **Step 6: Update audit report title**
...
- [x] **Step 7: Update install script message**
...
- [x] **Step 9: Commit compiler, governor, and audit**
...
- [x] **Step 1: Capture pre-install git status**
...
- [x] **Step 3: Confirm no new tracked runtime memory changes**
...
- [x] **Step 4: Inspect audit report side effect**
...
- [x] **Step 5: Commit hook change only if needed**
...
- [x] **Step 2: Run full red-team audit**
...
- [x] **Step 3: Run install verification**
...
- [x] **Step 4: Check compiled context**
...
- [x] **Step 6: Final commit for plan/spec amendments**
