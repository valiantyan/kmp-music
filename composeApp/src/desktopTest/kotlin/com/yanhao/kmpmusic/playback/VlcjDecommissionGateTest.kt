...
class VlcjDecommissionGateTest {
    ...
    private companion object {
        ...
        private val forbiddenTokens: List<String> =
            listOf(
                "vlcj",
                "LibVLC",
                "VLC_PLUGIN_PATH",
        ...
        private val scannedExtensions: Set<String> =
            setOf(
                "c",
                "cc",
                "cpp",
        ...
        private val scannedFileNames: Set<String> =
            setOf(
                "SOURCE_RECORD",
            )
    }
