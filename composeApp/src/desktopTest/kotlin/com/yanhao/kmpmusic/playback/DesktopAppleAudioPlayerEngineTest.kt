...
class DesktopAppleAudioPlayerEngineTest {
    ...
    @Test
    fun setQueuePreparesBridgeWithAudioSourceUriAndGeneration(): Unit =
        runTest {
    ...
    @Test
    fun setQueueClampsRestoredPositionToMediaDuration(): Unit =
        runTest {
            val bridge: FakeApplePlaybackBridge = FakeApplePlaybackBridge()
            val engine: DesktopAppleAudioPlayerEngine = testEngine(bridge = bridge)
    ...
    @Test
    fun bridgeEventsMapToPlaybackFacts(): Unit =
        runTest {
            val bridge: FakeApplePlaybackBridge = FakeApplePlaybackBridge()
            val engine: DesktopAppleAudioPlayerEngine = testEngine(bridge = bridge)
            val events: MutableList<PlaybackEngineEvent> = mutableListOf()
    ...
    @Test
    fun prepareFailureInvalidatesSameGenerationCallbacks(): Unit =
        runTest {
            val bridge: FakeApplePlaybackBridge = FakeApplePlaybackBridge()
            val engine: DesktopAppleAudioPlayerEngine = testEngine(bridge = bridge)
            val events: MutableList<PlaybackEngineEvent> = mutableListOf()
            ...
            assertFalse(
                actual =
                    events.any { event: PlaybackEngineEvent ->
                        event ==
                            PlaybackEngineEvent.StatusChanged(
                                status = PlaybackStatus.Playing,
                                positionMs = 12_000L,
    ...
    @Test
    fun seekSkipRaceIgnoresStaleGenerationCallbacks(): Unit =
        runTest {
            val bridge: FakeApplePlaybackBridge = FakeApplePlaybackBridge()
            val engine: DesktopAppleAudioPlayerEngine = testEngine(bridge = bridge)
            val events: MutableList<PlaybackEngineEvent> = mutableListOf()
    ...
    @Test
    fun seekAfterPreparedSendsBridgeCommandAndProgress(): Unit =
        runTest {
            val bridge: FakeApplePlaybackBridge = FakeApplePlaybackBridge()
            val engine: DesktopAppleAudioPlayerEngine = testEngine(bridge = bridge)
            val events: MutableList<PlaybackEngineEvent> = mutableListOf()
    ...
    @Test
    fun seekAfterPreparedClampsPositionToMediaDuration(): Unit =
        runTest {
            val bridge: FakeApplePlaybackBridge = FakeApplePlaybackBridge()
            val engine: DesktopAppleAudioPlayerEngine = testEngine(bridge = bridge)
            val events: MutableList<PlaybackEngineEvent> = mutableListOf()
    ...
    @Test
    fun prepareAckFailureInvalidatesGeneration(): Unit =
        runTest {
            val bridge: FakeApplePlaybackBridge = FakeApplePlaybackBridge()
            val engine: DesktopAppleAudioPlayerEngine = testEngine(bridge = bridge)
            val events: MutableList<PlaybackEngineEvent> = mutableListOf()
    ...
    @Test
    fun seekAckTimeoutEmitsFailedEvent(): Unit =
        runTest {
            val bridge: FakeApplePlaybackBridge = FakeApplePlaybackBridge()
            val engine: DesktopAppleAudioPlayerEngine = testEngine(bridge = bridge)
            val events: MutableList<PlaybackEngineEvent> = mutableListOf()
    ...
    @Test
    fun endedCallbackOnlyEmitsEndedEvent(): Unit =
        runTest {
            val bridge: FakeApplePlaybackBridge = FakeApplePlaybackBridge()
            val engine: DesktopAppleAudioPlayerEngine = testEngine(bridge = bridge)
            val events: MutableList<PlaybackEngineEvent> = mutableListOf()
    ...
    @Test
    fun stopSendsBridgeCommandAndEmitsIdle(): Unit =
        runTest {
            val bridge: FakeApplePlaybackBridge = FakeApplePlaybackBridge()
            val engine: DesktopAppleAudioPlayerEngine = testEngine(bridge = bridge)
            val events: MutableList<PlaybackEngineEvent> = mutableListOf()
    ...
    @Test
    fun releaseIgnoresDelayedCallbacksAndSetQueueReturns(): Unit =
        runTest {
            val bridge: FakeApplePlaybackBridge = FakeApplePlaybackBridge()
            val engine: DesktopAppleAudioPlayerEngine = testEngine(bridge = bridge)
            val events: MutableList<PlaybackEngineEvent> = mutableListOf()
    ...
    @Test
    fun initializationFailureMapsToFailedEvent(): Unit =
        runTest {
            val bridge: FakeApplePlaybackBridge = FakeApplePlaybackBridge()
            val engine: DesktopAppleAudioPlayerEngine = testEngine(bridge = bridge)
            val events: MutableList<PlaybackEngineEvent> = mutableListOf()
