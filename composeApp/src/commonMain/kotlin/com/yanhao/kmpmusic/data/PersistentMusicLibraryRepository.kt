...
class PersistentMusicLibraryRepository(
    ...
    override fun applyScanResult(
        ...
        runBlocking {
            val coveredSourceKinds: Set<String> =
                resolveCoveredSourceKinds(
                    scanResult = scanResult,
                )
            val coveredConcreteSources: List<LocalMusicScanCoverage.ConcreteSource> =
                resolveCoveredConcreteSources(
                    scanResult = scanResult,
                )
            val discoveredEntities: List<LocalSongEntity> =
            ...
            val previousAvailableIds: Set<String> =
                localSongDao
                    .getAllAvailableSongs()
                    .map { entity: LocalSongEntity -> entity.id }
                    .toSet()
            val previousIdsBySourceKind: Map<String, Set<String>> =
                coveredSourceKinds.associateWith { sourceKind: String ->
            ...
            val previousIdsByConcreteSource: Map<LocalMusicScanCoverage.ConcreteSource, Set<String>> =
                coveredConcreteSources.associateWith { coverage: LocalMusicScanCoverage.ConcreteSource ->
                    localSongDao
                        .getAvailableSongIdsByConcreteSource(
            ...
            coveredSourceKinds.forEach { sourceKind: String ->
                val discoveredIds: Set<String> =
                    discoveredSongIdsForSourceKind(
            ...
            coveredConcreteSources.forEach { coverage: LocalMusicScanCoverage.ConcreteSource ->
                val discoveredIds: Set<String> =
                    discoveredSongIdsForConcreteSource(
                        discoveredEntities = discoveredEntities,
                        coverage = coverage,
                    )
            ...
            val summary: LocalMusicLastScanSummary =
                LocalMusicLastScanSummary(
                    addedCount =
                        discoveredEntities.count { entity: LocalSongEntity ->
    ...
    private fun mapEntities(
        ...
        entities.mapIndexed { index: Int, entity: LocalSongEntity ->
            entity.toSong(
                index = index,
    ...
    private fun resolveCoveredSourceKinds(
        ...
        val fromCompletedCoverage: Set<String> =
            scanResult.completedCoverage
    ...
    private fun countRemovedSongs(
        ...
        val removedBySourceKind: Int =
            coveredSourceKinds.sumOf { sourceKind: String ->
                val discoveredIds: Set<String> =
                    discoveredSongIdsForSourceKind(
                        discoveredEntities = discoveredEntities,
                        sourceKind = sourceKind,
        ...
        val removedByConcreteSource: Int =
            coveredConcreteSources.sumOf { coverage: LocalMusicScanCoverage.ConcreteSource ->
                val discoveredIds: Set<String> =
                    discoveredSongIdsForConcreteSource(
                        discoveredEntities = discoveredEntities,
                        coverage = coverage,
    ...
    private fun LocalSongEntity.toSong(
        ...
        val safeTitle: String =
            title?.takeIf { value: String -> value.isNotBlank() }
        ...
        return Song(
            ...
            sourceId = sourceId,
            sourceKind =
                LocalMusicSourceKind.entries.firstOrNull { kind: LocalMusicSourceKind ->
