...
class PersistentLocalPlaylistRepository(
    ...
    override fun createPlaylistWithSong(
        ...
        runBlocking {
            ...
            val trimmedName: String = name.trim()
            val validationResult: CreateLocalPlaylistWithSongResult? =
                validateCreateNameForAtomicFlow(
            ...
            runInWriteTransaction {
                ...
                val relationEntity: LocalPlaylistSongEntity =
    ...
    override fun addSongToPlaylist(
        ...
        runBlocking {
            val playlist: LocalPlaylistEntity =
                playlistDao.getPlaylistById(playlistId = playlistId)
                    ?: return@runBlocking AddSongToLocalPlaylistResult.PlaylistNotFound
            val existingRelation: LocalPlaylistSongEntity? =
                playlistSongDao.getRelation(
            ...
            val relation: LocalPlaylistSongEntity =
                LocalPlaylistSongEntity(
    ...
    override fun searchPlaylists(query: String): List<LocalPlaylist> =
        runBlocking {
            ...
            playlistDao
                .searchPlaylists(escapedQuery = normalizedQuery.toEscapedLikeQuery())
    ...
    private suspend fun validateCreateNameForAtomicFlow(
        ...
        when (validateCreateName(trimmedName = trimmedName)) {
    ...
    private fun resolveAvailableSongsInRelationOrder(
        ...
        val songsById: Map<String, Song> =
            musicLibraryRepository
                .getAvailableSongsByIds(songIds = songIds)
