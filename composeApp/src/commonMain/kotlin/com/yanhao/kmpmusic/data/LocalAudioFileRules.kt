...
object LocalAudioFileRules {
    ...
    fun coverForSourceId(sourceId: String): CoverArt = CoverArt.HeroLocalMusic
...
object AppleAudioFormatSupportMatrix {
     ...
     */
    val entries: List<AppleAudioFormatSupport> =
        listOf(
    ...
    internal val scannableAudioTypesByExtension: Map<String, LocalAudioType> =
        entries
