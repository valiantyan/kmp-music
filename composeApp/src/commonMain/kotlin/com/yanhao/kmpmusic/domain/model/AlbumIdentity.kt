 ...
 */
fun normalizeAlbumTitle(value: String): String = value.trim().lowercase()
 ...
 */
fun hasSameAlbumTitle(
    firstTitle: String,
    secondTitle: String,
): Boolean = normalizeAlbumTitle(value = firstTitle) == normalizeAlbumTitle(value = secondTitle)
