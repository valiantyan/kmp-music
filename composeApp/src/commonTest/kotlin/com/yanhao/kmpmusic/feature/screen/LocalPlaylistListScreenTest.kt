...
class LocalPlaylistListScreenTest {
     ...
     */
    @Test
    fun buildLocalPlaylistCountSummaryShowsPlaylistCount(): Unit {
        val playlists: List<LocalPlaylistCardDisplayModel> = listOf(
     ...
     */
    @Test
    fun buildLocalPlaylistCountSummarySupportsEmptyList(): Unit {
...
private fun testPlaylistCard(id: String): LocalPlaylistCardDisplayModel {
    return LocalPlaylistCardDisplayModel(
        id = id,
        name = "测试歌单",
