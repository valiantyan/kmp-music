...
class ArtistDetailScrollBehaviorTest {
     ...
     */
    @Test
    fun collapseProgressIsClamped() {
        val spec: ArtistDetailScrollSpec = testScrollSpec()

        val beforeTop: ArtistDetailScrollState =
            calculateArtistDetailScrollState(
                spec = spec,
                scrollOffset = (-24).dp,
                pullOffset = 0.dp,
            )
        val afterCollapse: ArtistDetailScrollState =
            calculateArtistDetailScrollState(
                spec = spec,
                scrollOffset = 800.dp,
                pullOffset = 0.dp,
     ...
     */
    @Test
    fun toolbarAlphaAndTitleAlphaFollowCollapseProgress() {
        val spec: ArtistDetailScrollSpec = testScrollSpec()
        val expanded: ArtistDetailScrollState =
            calculateArtistDetailScrollState(
                spec = spec,
                scrollOffset = 0.dp,
                pullOffset = 0.dp,
            )
        val halfCollapsed: ArtistDetailScrollState =
            calculateArtistDetailScrollState(
                spec = spec,
                scrollOffset = 150.dp,
                pullOffset = 0.dp,
            )
        val collapsed: ArtistDetailScrollState =
            calculateArtistDetailScrollState(
                spec = spec,
                scrollOffset = 400.dp,
                pullOffset = 0.dp,
     ...
     */
    @Test
    fun collapsedToolbarHeightIncludesStatusBarInset() {
        val spec: ArtistDetailScrollSpec =
            testScrollSpec(
                statusBarInset = 28.dp,
                toolbarContentHeight = 56.dp,
            )

        val state: ArtistDetailScrollState =
            calculateArtistDetailScrollState(
                spec = spec,
                scrollOffset = 0.dp,
                pullOffset = 0.dp,
     ...
     */
    @Test
    fun pullStretchHeightIsLimited() {
     ...
     */
    @Test
    fun layoutStateMatchesScrollStateWithoutListScrollOffset() {
        val spec: ArtistDetailScrollSpec = testScrollSpec(maxPullStretchHeight = 96.dp)
        ...
        val scrollState: ArtistDetailScrollState =
            calculateArtistDetailScrollState(
                spec = spec,
                scrollOffset = 240.dp,
                pullOffset = 120.dp,
     ...
     */
    @Test
    fun expandedHeaderHeightUsesHalfOfViewport() {
        val spec: ArtistDetailScrollSpec =
     ...
     */
    @Test
    fun contentGroupStartsInsideHeroLowerMiddle() {
        val spec: ArtistDetailScrollSpec =
            testScrollSpec(
     ...
     */
    @Test
    fun toolbarRevealCompletesWhenContentGroupReachesTopBarrier() {
        val spec: ArtistDetailScrollSpec =
            testScrollSpec(
                expandedHeaderHeight = 440.dp,
                statusBarInset = 24.dp,
        ...
        val revealed: ArtistDetailScrollState =
            calculateArtistDetailScrollState(
                spec = spec,
     ...
     */
    @Test
    fun toolbarRevealProgressFollowsContentGroupSpacer() {
        val spec: ArtistDetailScrollSpec =
            testScrollSpec(
                expandedHeaderHeight = 440.dp,
                statusBarInset = 24.dp,
     ...
     */
    @Test
    fun heroImageMovesUpWithScrollOffset() {
        val spec: ArtistDetailScrollSpec =
            testScrollSpec(
                expandedHeaderHeight = 440.dp,
                statusBarInset = 24.dp,
     ...
     */
    @Test
    fun scrollOffsetAccumulatesHeaderItemsBeforePlayAllAnchor() {
        val spec: ArtistDetailScrollSpec =
            testScrollSpec(
                expandedHeaderHeight = 440.dp,
                statusBarInset = 24.dp,
        ...
        val scrollOffset: androidx.compose.ui.unit.Dp =
            calculateArtistDetailScrollOffsetFromListPosition(
     ...
     */
    @Test
    fun scrollOffsetAccumulatesHeaderItemsBeforePlayAllSectionHeader() {
        val spec: ArtistDetailScrollSpec =
            testScrollSpec(
                expandedHeaderHeight = 440.dp,
                statusBarInset = 24.dp,
     ...
     */
    @Test
    fun heroImageScrollsOutByOffsetInsteadOfHeightCollapse() {
        val spec: ArtistDetailScrollSpec =
            testScrollSpec(
     ...
     */
    @Test
    fun headerVisibleHeightCollapsesIndependentlyFromContentGroup() {
        val spec: ArtistDetailScrollSpec =
            testScrollSpec(
                expandedHeaderHeight = 420.dp,
                statusBarInset = 24.dp,
     ...
     */
    @Test
    fun heroImageHeightStaysExpandedWhileToolbarAppears() {
        val spec: ArtistDetailScrollSpec =
            testScrollSpec(
                expandedHeaderHeight = 420.dp,
                statusBarInset = 24.dp,
