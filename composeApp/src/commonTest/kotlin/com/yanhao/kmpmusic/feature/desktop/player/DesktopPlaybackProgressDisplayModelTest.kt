...
class DesktopPlaybackProgressDisplayModelTest {
    ...
    @Test
    fun knownDurationUsesOriginalRange(): Unit {
        val model: DesktopPlaybackProgressDisplayModel = buildDesktopPlaybackProgressDisplayModel(
    ...
    @Test
    fun playingAtKnownDurationKeepsSliderBelowEndWhilePlaybackContinues(): Unit {
        val model: DesktopPlaybackProgressDisplayModel = buildDesktopPlaybackProgressDisplayModel(
    ...
    @Test
    fun staleDurationKeepsSliderBelowEndWhilePlaybackContinues(): Unit {
        val model: DesktopPlaybackProgressDisplayModel = buildDesktopPlaybackProgressDisplayModel(
    ...
    @Test
    fun pausedAtKnownDurationKeepsSliderAtEnd(): Unit {
        val model: DesktopPlaybackProgressDisplayModel = buildDesktopPlaybackProgressDisplayModel(
            playbackPositionMs = 189_000L,
            playbackDurationMs = 189_000L,
            isPlaying = false,
    ...
    @Test
    fun unknownDurationDisablesSeek(): Unit {
        val model: DesktopPlaybackProgressDisplayModel = buildDesktopPlaybackProgressDisplayModel(
            playbackPositionMs = 30_000L,
