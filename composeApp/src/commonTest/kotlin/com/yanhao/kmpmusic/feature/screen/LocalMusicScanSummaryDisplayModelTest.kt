...
class LocalMusicScanSummaryDisplayModelTest {
     ...
     */
    @Test
    fun scanSummaryDisplayModelShowsPlayableTotalAndLastScanTimeOnly() {
        val model: LocalMusicScanSummaryDisplayModel =
     ...
     */
    @Test
    fun scanningSummaryDisplayModelKeepsPreviousLastScanTime() {
        val model: LocalMusicScanSummaryDisplayModel =
            buildLocalMusicScanSummaryDisplayModel(
                playableSongCount = 42,
                scanState =
     ...
     */
    @Test
    fun scanActionLabelsUsePlatformSpecificEntryCopy() {
        assertEquals(
            expected = "开始扫描",
            actual =
     ...
     */
    @Test
    fun sourceKindLabelsUsePlatformSpecificSourceCopy() {
        assertEquals(
            expected = "Android 媒体库",
            actual =
                localMusicSourceKindLabel(
