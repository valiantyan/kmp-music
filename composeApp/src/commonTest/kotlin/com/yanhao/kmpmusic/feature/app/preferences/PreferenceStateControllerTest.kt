...
class PreferenceStateControllerTest {
     ...
     */
    @Test
    fun localMusicDiscoveryPreferenceUpdatesOnlyRequestedField() {
        val repository: InMemoryUserPreferencesRepository = InMemoryUserPreferencesRepository()
        val controller: PreferenceStateController =
            PreferenceStateController(
                userPreferencesRepository = repository,
        ...
        val updatedState: MusicAppUiState =
            controller.setLocalMusicSystemFoldersExcluded(
                state = state,
                isExcluded = false,
            )
