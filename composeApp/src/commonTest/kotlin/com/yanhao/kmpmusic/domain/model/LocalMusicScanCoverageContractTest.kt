...
class LocalMusicScanCoverageContractTest {
     ...
     */
    @Test
    fun positiveOnlyResultHasNoDeletionAuthority() {
     ...
     */
    @Test
    fun completedCoverageIsExplicitAndNotInferredFromDiscoveredOrSourceSummaries() {
        val result: LocalMusicScanResult =
            LocalMusicScanResult(
     ...
     */
    @Test
    fun failedResultHasNoDeletionAuthorityEvenWithCompletedCoverage() {
        val result: LocalMusicScanResult =
            LocalMusicScanResult(
     ...
     */
    @Test
    fun coverageModelDistinguishesSourceKindConcreteSourceAndPositiveOnly() {
        val androidCoverage: LocalMusicScanCoverage =
            LocalMusicScanCoverage.SourceKind(
                sourceKind = LocalMusicSourceKind.AndroidMediaStore,
            )
        val desktopFolderCoverage: LocalMusicScanCoverage =
     ...
     */
    @Test
    fun scannersMustDeclareCoverageSemanticsAtResultBoundary() {
        val fakeResult: LocalMusicScanResult =
            LocalMusicScanResult(
        ...
        val platformImportResult: LocalMusicScanResult =
            LocalMusicScanResult(
