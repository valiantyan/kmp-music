...
class PlaybackSnapshotStoreTest {
     ...
     */
    @Test
    fun getSavedSnapshotIdentityReturnsSavedQueueCurrentSongAndUpdatedAt(): Unit =
        runTest {
     ...
     */
    @Test
    fun getSavedSnapshotIdentityReturnsNullWithoutQueue(): Unit =
        runTest {
            val store: InMemoryPlaybackSnapshotStore = InMemoryPlaybackSnapshotStore()
     ...
     */
    @Test
    fun getSavedSnapshotIdentityReturnsNullWhenCurrentSongIsMissing(): Unit =
        runTest {
            val store: InMemoryPlaybackSnapshotStore = InMemoryPlaybackSnapshotStore()
            store.saveSnapshot(
                snapshot =
     ...
     */
    @Test
    fun saveAndRestoreSnapshotKeepsQueueOrderAndPausedStatus(): Unit =
        runTest {
            val store: InMemoryPlaybackSnapshotStore = InMemoryPlaybackSnapshotStore()
     ...
     */
    @Test
    fun restoreFiltersMissingSongs(): Unit =
        runTest {
            val store: InMemoryPlaybackSnapshotStore = InMemoryPlaybackSnapshotStore()
            store.saveSnapshot(
                snapshot =
     ...
     */
    @Test
    fun restoreReturnsIdleWhenQueueBecomesEmptyAfterFiltering(): Unit =
        runTest {
            val store: InMemoryPlaybackSnapshotStore = InMemoryPlaybackSnapshotStore()
            store.saveSnapshot(
                snapshot =
     ...
     */
    @Test
    fun restoreResetsPositionWhenCurrentSongIsMissing(): Unit =
        runTest {
            val store: InMemoryPlaybackSnapshotStore = InMemoryPlaybackSnapshotStore()
            store.saveSnapshot(
                snapshot =
