...
class FakeAudioPlayerEngineTest {
     ...
     */
    @Test
    fun playAndPauseReuseQueueStartPosition(): Unit =
        runBlocking {
     ...
     */
    @Test
    fun pauseUsesLatestSeekPosition(): Unit =
        runBlocking {
            val engine = FakeAudioPlayerEngine()
            val eventsDeferred =
                async {
     ...
     */
    @Test
    fun emptySetQueueEmitsFailure(): Unit =
        runBlocking {
            val engine = FakeAudioPlayerEngine()
            val eventsDeferred =
                async {
     ...
     */
    @Test
    fun emptySkipToIndexEmitsFailure(): Unit =
        runBlocking {
            val engine = FakeAudioPlayerEngine()
            val eventsDeferred =
                async {
     ...
     */
    @Test
    fun setPlaybackModeRecordsLatestMode() {
        val engine = FakeAudioPlayerEngine()
