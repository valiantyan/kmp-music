...
class PersistentLocalPlaylistRepositoryTest {
     ...
     */
    @Test
    fun createPlaylistTrimsOnlyOuterSpacesAndPersistsTimestamps(): Unit =
        runTest {
     ...
     */
    @Test
    fun createPlaylistRejectsBlankAndExactDuplicateOnly(): Unit =
        runTest {
     ...
     */
    @Test
    fun nextDefaultPlaylistNameUsesFirstAvailablePositiveIndex(): Unit =
        runTest {
            val fixture: LocalPlaylistRepositoryFixture = LocalPlaylistRepositoryFixture()
            val repository: LocalPlaylistRepository = fixture.createRepository()
     ...
     */
    @Test
    fun searchPlaylistsIsCaseInsensitiveAndKeepsCreateRulesSeparate(): Unit =
        runTest {
            val fixture: LocalPlaylistRepositoryFixture = LocalPlaylistRepositoryFixture()
            val repository: LocalPlaylistRepository = fixture.createRepository()
     ...
     */
    @Test
    fun searchPlaylistsTreatsSqlWildcardsAsLiteralCharacters(): Unit =
        runTest {
            val fixture: LocalPlaylistRepositoryFixture = LocalPlaylistRepositoryFixture()
            val repository: LocalPlaylistRepository = fixture.createRepository()
     ...
     */
    @Test
    fun addSongToPlaylistPersistsStableOrderAndReadsLatestAddedFirst(): Unit =
        runTest {
            val fixture: LocalPlaylistRepositoryFixture =
                LocalPlaylistRepositoryFixture(
                    nowValues = listOf(10L, 20L, 30L),
                    availableSongs = listOf(song(id = "song-1"), song(id = "song-2")),
                )
            val repository: LocalPlaylistRepository = fixture.createRepository()
            val playlist: LocalPlaylist =
                assertIs<LocalPlaylistCreateResult.Success>(
     ...
     */
    @Test
    fun addSongToPlaylistIsIdempotentForExistingSongRelation(): Unit =
        runTest {
            val fixture: LocalPlaylistRepositoryFixture =
                LocalPlaylistRepositoryFixture(
                    nowValues = listOf(10L, 20L, 30L),
            ...
            val duplicateResult: AddSongToLocalPlaylistResult =
                repository.addSongToPlaylist(
                    playlistId = playlist.id,
                    songId = "song-1",
                )
     ...
     */
    @Test
    fun createPlaylistWithSongRunsInsideWriteTransaction(): Unit =
        runTest {
            val fixture: LocalPlaylistRepositoryFixture =
                LocalPlaylistRepositoryFixture(
                    availableSongs = listOf(song(id = "song-1")),
     ...
     */
    @Test
    fun createPlaylistWithUnavailableSongLeavesNoEmptyPlaylist(): Unit =
        runTest {
     ...
     */
    @Test
    fun createPlaylistWithSongRollsBackPlaylistWhenRelationInsertFails(): Unit =
        runTest {
            val fixture: LocalPlaylistRepositoryFixture =
                LocalPlaylistRepositoryFixture(
                    availableSongs = listOf(song(id = "song-1")),
     ...
     */
    @Test
    fun playlistDetailFiltersUnavailableSongsButKeepsRelations(): Unit =
        runTest {
            val fixture: LocalPlaylistRepositoryFixture =
                LocalPlaylistRepositoryFixture(
                    availableSongs = listOf(song(id = "song-1"), song(id = "song-2")),
            ...
            val repository: LocalPlaylistRepository = fixture.createRepository()
            val playlist: LocalPlaylist =
                assertIs<CreateLocalPlaylistWithSongResult.Success>(
                    value =
                        repository.createPlaylistWithSong(
                            name = "恢复测试",
                            songId = "song-1",
     ...
     */
    @Test
    fun getPlaylistsSortsByUpdatedAtDescendingThenNameAscending(): Unit =
        runTest {
     ...
     */
    @Test
    fun deletePlaylistsRemovesMetadataAndRelationsOnly(): Unit =
        runTest {
            ...
            val repository: LocalPlaylistRepository = fixture.createRepository()
            val keepPlaylist: LocalPlaylist =
                assertIs<CreateLocalPlaylistWithSongResult.Success>(
                    value =
                        repository.createPlaylistWithSong(
                            name = "保留",
            ...
            val deletePlaylist: LocalPlaylist =
                assertIs<CreateLocalPlaylistWithSongResult.Success>(
                    value =
                        repository.createPlaylistWithSong(
                            name = "删除",
    ...
    private class LocalPlaylistRepositoryFixture(
        ...
        private val playlistSongDao: FakeLocalPlaylistSongDao =
            FakeLocalPlaylistSongDao(
                shouldFailRelationInsert = shouldFailRelationInsert,
            )

        // 可变曲库仓库用来验证不可用歌曲过滤。
        val musicLibraryRepository: FakeMusicLibraryRepository =
    ...
    private class FakeLocalPlaylistDao : LocalPlaylistDao {
        ...
        /** 按 id 读取歌单。 */
        override suspend fun getPlaylistById(playlistId: String): LocalPlaylistEntity? = rows[playlistId]

        /** 按名称完全匹配读取歌单。 */
        override suspend fun getPlaylistByName(name: String): LocalPlaylistEntity? = rows.values.firstOrNull { entity: LocalPlaylistEntity -> entity.name == name }
        ...
        /** 保存当前表快照，供事务失败测试回滚。 */
        fun snapshotRows(): LinkedHashMap<String, LocalPlaylistEntity> = LinkedHashMap(rows)
    ...
    private class FakeLocalPlaylistSongDao(
        ...
        override suspend fun getRelation(
            playlistId: String,
            songId: String,
        ): LocalPlaylistSongEntity? = rows[playlistId to songId]
        ...
        /** 保存当前关系表快照，供事务失败测试回滚。 */
        fun snapshotRows(): LinkedHashMap<Pair<String, String>, LocalPlaylistSongEntity> = LinkedHashMap(rows)
    ...
    private class FakeMusicLibraryRepository(
        ...
        override fun getSnapshot(): com.yanhao.kmpmusic.domain.model.LibrarySnapshot = com.yanhao.kmpmusic.domain.model.LibrarySnapshot.Empty

        /** 返回首页预览，本测试不使用。 */
        override fun getHomePreview(limit: Int): List<Song> = availableSongs.take(n = limit)

        /** 返回当前可用歌曲。 */
        override fun getAllAvailableSongs(): List<Song> = availableSongs
        ...
        override fun getLibraryStats(): com.yanhao.kmpmusic.domain.model.LibraryStats =
            com.yanhao.kmpmusic.domain.model
                .LibraryStats()
        ...
        ): com.yanhao.kmpmusic.domain.model.LibrarySnapshot = com.yanhao.kmpmusic.domain.model.LibrarySnapshot.Empty
    }
