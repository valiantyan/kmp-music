...
class PersistentSearchHistoryRepositoryTest {
     ...
     */
    @Test
    fun saveSearchHistoryPersistsByContextAcrossRepositoryInstances(): Unit =
        runTest {
            ...
            val restoredRepository: SearchHistoryRepository =
                PersistentSearchHistoryRepository(
                    searchHistoryDao = dao,
                )
     ...
     */
    @Test
    fun saveSearchHistoryReplacesOldContextRows(): Unit =
        runTest {
            val dao: FakeSearchHistoryDao = FakeSearchHistoryDao()
            val repository: SearchHistoryRepository =
                PersistentSearchHistoryRepository(
     ...
     */
    @Test
    fun saveSearchHistoryRunsInsideWriteTransaction(): Unit =
        runTest {
            val dao: FakeSearchHistoryDao = FakeSearchHistoryDao()
