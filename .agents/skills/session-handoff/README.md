...
```bash
python scripts/validate_handoff.py handoff/2024-01-15-143022-implementing-auth.md
```
...
```bash
python scripts/check_staleness.py handoff/2024-01-15-143022-implementing-auth.md
```
...
Handoffs are stored in: `handoff/` in the current project
